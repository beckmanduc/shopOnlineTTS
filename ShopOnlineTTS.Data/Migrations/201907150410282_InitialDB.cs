    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.PrroductCategories", t => t.CategoryID, cascadeDelete: true)
                .Index(t => t.CategoryID);
            
            CreateTable(
                "dbo.PrroductCategories",
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Products", "CategoryID", "dbo.PrroductCategories");
            ...
            DropTable("dbo.Pages");
            DropTable("dbo.PrroductCategories");
